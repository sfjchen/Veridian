...
import type { ChatMessage } from '../lib/studentApi';
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 16, fontWeight: '700', color: palette.textPrimary },
  closeBtn: {
    width: 32,
    height: 32,
    borderRadius: 16,
  ...
  closeBtnText: { fontSize: 14, fontWeight: '700', color: palette.textSecondary },
  quickActions: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 8,
  ...
  quickActionText: { fontSize: 13, color: palette.textSecondary, fontWeight: '500' },
  messageList: { flex: 1 },
  ...
  studentBubble: { alignSelf: 'flex-end', backgroundColor: palette.primary },
  assistantBubble: { alignSelf: 'flex-start', backgroundColor: palette.surface },
  studentText: { color: palette.white, fontSize: 14, lineHeight: 20 },
  assistantText: { color: palette.textPrimary, fontSize: 14, lineHeight: 20 },
  errorBar: { paddingHorizontal: 16, paddingVertical: 6, backgroundColor: palette.errorBg },
  errorText: { fontSize: 13, color: palette.errorText },
  inputBar: {
    flexDirection: 'row',
    alignItems: 'flex-end',
    paddingHorizontal: 12,
  ...
  sendBtnText: { color: palette.white, fontSize: 14, fontWeight: '700' },
});
