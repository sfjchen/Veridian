    ...
    <ScreenContainer maxWidth="form">
      ...
      >
        <Card style={StyleSheet.flatten([styles.card, elevation.shadowMd])}>
          ...
          <Button onPress={handleSignup} loading={loading} fullWidth style={styles.button} accessibilityLabel="Sign up">
            Sign Up
          </Button>
          <TouchableOpacity onPress={() => navigation.navigate("Login")} style={styles.linkWrap} accessibilityLabel="Go to sign in">
