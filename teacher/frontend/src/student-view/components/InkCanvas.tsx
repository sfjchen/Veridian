      ...
      {showToolbar && (
        ...
        <View style={styles.toolbar}>
          <Pressable
            ...
            <MaterialCommunityIcons name="pencil" size={20} color={tool === 'pen' ? palette.white : palette.primary} />
          </Pressable>
          <Pressable
            style={({ pressed }) => [
              styles.toolIconButton,
            ...
            <MaterialCommunityIcons name="eraser" size={20} color={tool === 'eraser' ? palette.white : palette.primary} />
          </Pressable>
          <Pressable
            style={({ pressed }) => [
              styles.toolIconButton,
            ...
            <MaterialCommunityIcons name="undo" size={20} color={(canUndo || hasExternalUndo) ? palette.primary : palette.textDisabled} />
          </Pressable>
          <Pressable
            style={({ pressed }) => [
              styles.toolIconButton,
            ...
            <MaterialCommunityIcons name="redo" size={20} color={(canRedo || hasExternalRedo) ? palette.primary : palette.textDisabled} />
          </Pressable>
...
const styles = StyleSheet.create({
  ...
  toolIconButtonActive: { backgroundColor: palette.primary, borderColor: palette.primary },
  toolIconButtonDisabled: { opacity: 0.5 },
  ...
  clearButtonText: { color: palette.primary, fontSize: 13, fontWeight: '600' },
  canvasWrap: { flex: 1, backgroundColor: 'transparent', overflow: 'hidden' },
  touchLayer: { flex: 1 },
